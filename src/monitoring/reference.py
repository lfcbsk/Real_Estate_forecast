    ...
    for col in df.columns:
        ...
        if pd.api.types.is_numeric_dtype(col_data):
            stats[col] = {
                ...
                "std": float(col_data.std(ddof=0)) if null_count < total_count else None, # ddof=0: population std dev
        ...
        # 2. Thống kê cho cột phân loại (Categorical / Object / String)
            ...
            stats[col] = {
                ...
                "top_freq": top_freq,
                "top_freq_pct": round(top_freq / (total_count - null_count), 4) if (total_count - null_count) > 0 else 0.0
            }
        else:
